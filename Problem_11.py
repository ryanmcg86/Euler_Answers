...
#Build a function that finds the maximum product 
#in the grid for all numbers in a vertical row
def upDownMax(grid):
	maxProd = 0
...
#Build a function that finds the maximum product 
#in the grid for all numbers in a horizontal row
def leftRightMax(grid):
	maxProd = 0
...
#Build a function that finds the maximum product
#in the grid for all numbers in a diagonal from 
